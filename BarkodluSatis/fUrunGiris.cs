    ...
    public partial class fUrunGiris : Form
    {
        ...
        private void tBarkod_KeyDown(object sender, KeyEventArgs e)
        {
            if(e.KeyCode==Keys.Enter)
            {
                ...
                {
                    MessageBox.Show("Ürüm kayıtlı değil, kaydedebilirsiniz");
                }
            }
        }
        ...
        {
            if(tBarkod.Text!="" && tUrunAdi.Text!=""&&tAlisFiyati.Text!=""&&tSatisFiyati.Text!=""&&tKdvOrani.Text!="" && tMiktar.Text!="")
            {
                if(db.Urun.Any(a=> a.Barkod==tBarkod.Text)) //ürün güncelleme alanı
                {
                ...
                else //ürün ekleme alanı
                {
                    ...
                    {
                        var ozelbarkod = db.Barkod.First(); //barkod numarasını al ve bir artır.
